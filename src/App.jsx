...
const globalCSS = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; cursor: none !important; }
  ...
  .eyebrow { color: var(--text-muted); font-family: monospace; text-align: center; margin-bottom: 4rem; font-size: 14px; }
      ...
      <section id="hero" className="container reveal">
        <div className="hero">
          <div className="hero-left">
            <div className="eyebrow" style={{ textAlign: 'left', marginBottom: '3rem' }}>&lt; Mobile Engineer /&gt;</div>
            <h1 className="hero-title glitch">Uday<br />Jamariya</h1>

            <p className="hero-subtitle text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-400 font-bold tracking-widest text-lg md:text-xl drop-shadow-lg">Cross-Platform · Clean Architecture</p>
